...
public class QueryStringFunction {
     ...
     * 替换查询参数值
     * 
     * @param queryString 查询URL
     * @param paramName 参数名称
     * @param paramValue 参数值
     * @return 新查询URL
     */
    public static String replace(String queryString, String paramName, String paramValue) {
     ...
     * @return 新查询URL
     */
    public static String add(String queryString, String paramName, String paramValue) {
    ...
    public static String join(String sprator, String params1, String params2) {
        sprator = StringEscapeUtils.unescapeHtml(sprator);
        params1 = StringEscapeUtils.unescapeHtml(params1);
        params2 = StringEscapeUtils.unescapeHtml(params2);
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(StringEscapeUtils.unescapeHtml(t));
    }
}
